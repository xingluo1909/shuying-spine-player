...
## 📖 简介
  这是集**播放、格式转换、合并、超分**等等功能于一体的跨平台**非官方**spine播放器项目，支持macos及windows，目前已基本实现2.1到3.8到4.2的链路转换及其播放。
## ✨ 后续计划
  目前尚在进行测试的模块:
...
| **4.2** | ✅ | ✅ | ✅ | ✅ |
---
> 关于之后：考虑到时间、精力的缘故，之后我将暂缓对此项目的迭代。如果遇到无法读取，错误，失败等案例，欢迎提出，日后我会修改（当然，最好附带文件）。
